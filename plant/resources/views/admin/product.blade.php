                        ...
                        <div class="card-background">
                            <div class="form-area">
                                ...
                                <form action="{{'/add_product'}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <input type="number" min="0" name="quantity" placeholder="Enter product quantity" required="">

                                    <label>Discount Price</label>
                                    <input type="number" name="discount_price" placeholder="Enter discount price" >
                                    ...
                                    <input type="submit" value="Add Product" class="btn-submitr
